...
import { InputAdornment, TextField, Dialog, Select, FormControl, InputLabel, Button, MenuItem, Tooltip} from '@mui/material';
...
function NewDeductionModal(props) {
  ...
  const handleChange = (e) => {
    ...
    if(e.target.id == 'amount'){
      parseInt(e.target.value) > 0 ? setIsValidAmount(true) : setIsValidAmount(false);
    }
  };
        ...
        <Content >
          <Details >
            ...
            <Frame11 >
              ...
              <TextFieldStandard2 id="amount" value={Values.amount} type="number" variant="standard" size="medium" label={`Monto`} onChange={handleChange} required={true} disabled={!selectedProjectName} InputProps={{endAdornment: <InputAdornment position="end">{projectCurrency}</InputAdornment>}} />
            </Frame11>
