...
function NewProjectModal(props) {
  ...
  const validateFields = () => {
    setValidFields(() => isValidAmount && isValidBenefits && nameValue !== '' && frequencyValue !== '' && currencyValue !== '' && amountValue !== '' && benefitsValue !== '' && dateValue !== null && dateValue != 'Invalid Date' && (dateValue.toString().split(' ')[3][0] === '2'));
  }
  ...
  useEffect(() => { validateFields()}, [nameValue, frequencyValue, currencyValue, amountValue, benefitsValue, isValidAmount, isValidBenefits, dateValue]);
      ...
      <ModalBeneficio1 >
        ...
        <Cta >
          <Links >
            ...
            <span><Button variant="outlined" color="primary" size='large' endIcon={<ArrowForwardIcon />} onClick={sendProject} disabled={!validFields} > {`Crear Proyecto`} </Button></span>
            </Tooltip> 
            : <Button variant="outlined" color="primary" size='large' endIcon={<ArrowForwardIcon />} onClick={sendProject} disabled={!validFields} > {`Crear Proyecto`} </Button>}
          </Links>
        </Cta>
      </ModalBeneficio1>
     </Dialog>
