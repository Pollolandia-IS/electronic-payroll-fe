                ...
                <Details>
                    <Frame1>
                        ...
                        {props.selected ? (
                            ...
                            <IconButton
                                onClick={() => {
                                    props.setIsOpenAdd(true);
                                    props.setSelectedDeduction(props.name);
                                    props.setAmountChosen(props.amount);
                                    props.setDefaultAmount(props.amount);
                                }}
                                size="small"
                                color="primary"
                            >
                                <Tooltip
                                    title="Obtener Deducción"
                                    arrow
                                    placement="top"
                                >
